...
export function AIGenerateButton({ workAssignment, expectedOutput, onAccept }: AIGenerateButtonProps) {
  ...
  const handleStart = () => {
    const combined = `Work Assignment: ${workAssignment}\n\nExpected Output: ${expectedOutput}`;
    stream("generate" as AIMode, combined);
  };
